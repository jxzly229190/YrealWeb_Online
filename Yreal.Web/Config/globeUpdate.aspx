<%@ Page validateRequest="false" Title="" Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="globeUpdate.aspx.cs" Inherits="Yreal.Web.Config.globeUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceTitle" runat="server">
    网站配置
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" action="/Config/globeUpdate.aspx" runat="server">
