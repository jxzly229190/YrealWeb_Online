<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="Yreal.Web.Main" %>
...
<frameset rows="64,*"  frameborder="NO" border="0" framespacing="0">
  ...
  <frameset cols="200,*"  rows="560,*" id="frame">
	...
	<frame src="Welcome/Default.aspx" name="main" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto" target="_self" />
  </frameset>
<noframes>
  <body></body>
    </noframes>
